...
| Element Symbol | Name | Description |
   ...
   | **`🍖`** | **Food Meat** | Juicy primeval roasted meat scattered in the cave. Collect them to earn points (+10 score per meat). |
...
4. Each level requires collecting another **5 food meats** to unlock the exit portal.
